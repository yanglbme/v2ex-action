...
if __name__ == '__main__':
    input_hook = os.environ.get('INPUT_WEBHOOK')
    input_secret = os.environ.get('INPUT_SECRET')
    input_count = 8 if not os.environ.get('INPUT_COUNT') \
        else int(os.environ.get('INPUT_COUNT'))
